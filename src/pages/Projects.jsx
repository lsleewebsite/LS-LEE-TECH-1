...
function getPlaceholder(id = '0') {
  return PLACEHOLDER_IMAGES[String(id).charCodeAt(0) % PLACEHOLDER_IMAGES.length]
}
        ...
        >
          ...
          >
            <img
              ...
              onError={(e) => {
                e.target.src = getPlaceholder(project.id)
              }}
            />
...
export default function Projects() {
  ...
  const filtered =
    activeFilters.length === 0
      ? projects
      : projects.filter((p) =>
          activeFilters.some((f) => (p.categories || []).includes(f))
        )
  ...
  return (
    <div>
          ...
          <div style={{ position: 'relative' }}>
            <button
              ...
              style={{
                ...
                border: `2px solid ${
                  activeFilters.length > 0 ? '#DC2626' : '#0F172A'
                }`,
                fontWeight: 700,
                fontSize: '13px',
                      ...
                      >
                        <span
                          style={{
                            width: '14px',
                            height: '14px',
                            border: `2px solid ${isActive ? '#FFF' : '#DC2626'}`,
      ...
      <section
        style={{
          padding: isMobile ? '32px 16px' : '80px 32px',
          background: '#F8F9FA',
          minHeight: '400px',
        }}
      >
